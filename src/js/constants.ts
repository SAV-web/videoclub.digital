...
export const FILTER_CONFIG: Record<string, FilterGroup> = {
  selection: {
    label: "Selección",
    items: {
      "1001movies": "1001 Movies",
      tspdt: "TSPDT",
      criterion: "Criterion",
      kinolorber: "Kino Lorber",
      toptv: "Top TV",
      hbo: "Series HBO",
      acontra: "A Contra+",
      arrow: "Arrow",
    ...
    titles: {
      "1001movies": "1001 Películas que ver antes de morir",
      tspdt: "They Shoot Pictures, Don't They?",
      criterion: "The Criterion Collection",
      kinolorber: "Archivo Kino Lorber",
      hbo: "Series de HBO",
      toptv: "Mejores series según los rankings",
      acontra: "A Contracorriente Films",
      arrow: "Colección Arrow Video",
      eureka: "Colección Eureka",
      imprint: "Colección Imprint",
    },
  },
  studio: {
    label: "Estudios",

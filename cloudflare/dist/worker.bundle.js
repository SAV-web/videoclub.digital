...
function renderMovieHtml(movie, options = {}) {
  ...
  const spaTargetUrl = firstDirectorSlug ? `${baseUrl}?_p=/director/${firstDirectorSlug}/&movie=${movie.id}` : `${baseUrl}?movie=${movie.id}`;
...
<head>
  ...
  <!-- Anti-flicker para sincronizaci\xF3n exacta de modo claro/oscuro entre SPA y SEO -->
  <script>
    (function () {
      try {
          ...
          <div class="flip-card-front">
            ...
            <div class="poster-container">
              ...
              <div class="card-rating-block">
                ...
                <a href="${escapeAttr(spaTargetUrl)}" class="card-action-btn" title="A\xF1adir a mi lista en el videoclub" aria-label="A\xF1adir a mi lista en el videoclub">
    ...
    return `
                ...
                <div class="year-country-line">
                  <div class="year-flag-group">
                    ...
                    ` : ""}
                    ${countryCode ? `
                      <a href="${countrySlug ? `${baseUrl}?_p=/${countrySlug}/` : "#"}" class="country-info" data-template="country-container" style="display:flex; text-decoration:none;" title="${escapeAttr(countryName)}" aria-label="Ver t\xEDtulos de ${escapeAttr(countryName)} en el videoclub">
  ...
  return `
    <article class="movie-card" data-movie-id="${movie.id}" style="--card-index: ${index};">
      <div class="flip-card-inner">
        ...
        <!-- Cara trasera (Estructura y dise\xF1o id\xE9nticos a la SPA) -->
        <div class="flip-card-back">
          <div class="back-meta-header">
            <div class="episode-duration-group">
              ${episodesText ? `<span data-template="episodes">${escapeHtml(episodesText)}</span>` : ""}
          ...
          <div class="details-list">
            ${rawGenres.length > 0 ? `
              <div class="detail-item" data-template="genre-container">
                <span class="detail-label" title="G\xE9nero"><svg class="detail-icon" width="14" height="14" viewBox="0 0 24 24" aria-hidden="true"><use href="${baseUrl}sprite.svg#icon-clapperboard"></use></svg></span>
...
<body class="collection-wall">
  ...
  <script>
    (function () {
      ...
      // En escritorio, al salir el rat\xF3n de la ficha se repliega cualquier expansi\xF3n previa
      ...
      document.addEventListener("click", function (e) {
        ...
        // 3. Trasera ampliada: retroceder a la trasera normal al pulsar fuera del \xE1rea de enlaces
...
function renderSpaPersonCard(person, activeRole = "director", hasOtherRoleOrOptions = false, siteOriginArg = "https://videoclub.digital", baseUrlArg = "/") {
  ...
  const tooltipText = isDirector ? `Ver pel\xEDculas de ${person.name} como Actor` : `Ver pel\xEDculas de ${person.name} como Director`;
...
function renderPersonHtml(person, roleOrConfig = {}, hasOtherRoleLegacy, moviesLegacy = [], optionsLegacy = {}) {
  ...
  const roleTitle = hasBothRoles ? "Director y actor de cine" : isDirector ? "Director de cine" : "Actor cinematogr\xE1fico";
...
<body class="collection-wall">
  ...
  <!-- Handler de giro 3D, alternancia D/A y expansi\xF3n de reparto/biograf\xEDa en Vanilla JS -->
  <script>
    (function () {
      var activeCard = null;
      ...
      // Alternancia interactiva D/A para VIPs con ambos roles (c\xEDrculo \xFAnico D <-> A como en la SPA, URL inmutable)
      ...
      if (roleToggleBtn) {
        ...
        roleToggleBtn.addEventListener("click", function (e) {
          ...
          var tooltip = isDir
            ? "Ver pel\xEDculas de " + personName + " como Actor"
            : "Ver pel\xEDculas de " + personName + " como Director";

          // 1. Actualizar visualmente la letra y tooltip del c\xEDrculo \xFAnico (como en la SPA)
          if (letterSpan) {
          ...
          // 2. Conmutar el grid de pel\xEDculas visible sin mutar URL
      ...
      document.addEventListener("click", function (e) {
        ...
        // 4. Volteo 3D de la tarjeta (solo pel\xEDculas; la ficha VIP de actor/director no voltea)
...
`;
    ...
    const isPrefixedSeoRoute = lowerPath.startsWith("/titulo/") || lowerPath.startsWith("/genero/") || lowerPath.startsWith("/pais/") || lowerPath.startsWith("/estudio/") || lowerPath.startsWith("/seleccion/");
    ...
    const isTaxonomyRoute = lowerPath.startsWith("/genero/") || lowerPath.startsWith("/pais/") || lowerPath.startsWith("/estudio/") || lowerPath.startsWith("/seleccion/");
    if (isTaxonomyRoute) {

            ...
            <div class="movie-meta">
              ...
              <div class="year-country-line">
                <div class="year-flag-group">
                  ...
                  ${countryCode ? `
                    <a class="country-info" href="${countrySlug ? `${baseUrl}${countrySlug}/` : "#"}" title="${escapeAttr(countryName)}" aria-label="Ver t\xEDtulos de ${escapeAttr(countryName)}">
...
<body class="collection-wall">
  <div class="main-layout">
    <div class="main-content-wrapper">
      ...
      <header class="main-header">
        <div class="header-content" style="display:flex; justify-content:space-between; align-items:center; width:100%; max-width:1440px; margin-inline:auto;">
          ...
          <div class="main-header-primary-controls">
            <!-- P\xEDldora de Filtro Activo Id\xE9ntica a la SPA -->
      ...
      <!-- Muro Principal de Pel\xEDculas -->
      <main class="content">
      ...
      <footer class="site-footer">
        <div class="footer-content" style="max-width: 1440px; margin: 0 auto; padding: var(--space-md) var(--space-xs);">
          <ul class="footer-links">
            ...
            <li><a href="${baseUrl}sci-fi/">Ciencia Ficci\xF3n</a></li>
            <li><a href="${baseUrl}drama/">Drama</a></li>
            <li><a href="${baseUrl}espana/">Espa\xF1a</a></li>
          ...
          <p style="margin-top: 12px; font-size: 0.8rem; color: var(--color-text-tertiary);">
            \xA9 Videoclub Digital \u2014 Cat\xE1logo cinematogr\xE1fico de libre acceso
          </p>
        </div>
      </footer>
    </div>
  ...
  <!-- Handler de giro 3D en Vanilla JS para interacci\xF3n t\xE1ctil y de escritorio -->
  <script>
    (function () {
      var activeCard = null;

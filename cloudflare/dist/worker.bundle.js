...
<body class="collection-wall">
  ...
  <!-- Handler de acceso a la trasera y expansi\xF3n de reparto en Vanilla JS -->
  <script>
    (function () {
      var activeCard = null;
...
<body class="collection-wall">
  ...
  <!-- Handler de alternancia D/A, acceso a la trasera y expansi\xF3n de biograf\xEDa en Vanilla JS -->
  <script>
    (function () {
      var activeCard = null;
      ...
      document.addEventListener("click", function (e) {
        ...
        // 4. Volteo a la trasera al pulsar el cartel o cualquier lugar de la ficha (solo pel\xEDculas)
        var card = e.target.closest(".movie-card:not(.person-card)");
        if (card) {
          if (e.target.closest("a, button, [role='button'], .actors-scrollable-content, .scrollable-content")) return;
          var inner = card.querySelector(".flip-card-inner");
